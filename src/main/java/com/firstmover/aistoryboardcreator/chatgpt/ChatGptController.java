...
import com.firstmover.aistoryboardcreator.member.FormInputDTO;
import com.firstmover.aistoryboardcreator.member.OpenAiApiClient;
...
public class ChatGptController
{
    ...
    public String saveGeneratedContent(@RequestParam String scenario, @RequestParam String imageUri) {
        GeneratedContent content = new GeneratedContent();
        content.setScenario(scenario);
        content.setImageUri(imageUri);
        contentRepository.save(content);
        return "redirect:/"; // Redirect or show a success page
    }
    ...
    public String listContents(Model model) {
        ...
        return "listContents"; // listContents.html 뷰 이름
    }
